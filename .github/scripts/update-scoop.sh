...
git -c user.name="dirloom-package-mgr" -c user.email="330109029+dirloom-package-mgr@users.noreply.github.com" commit -m "chore(scoop): update dirloom to ${VERSION}"
