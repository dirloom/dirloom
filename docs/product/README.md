...
| Fidélité Nerd `v0.3.3` | Développement sur `release/v0.3.3` : provenance Nerd Fonts v3.5.1, logos vérifiés ou fallbacks, Compose/Bake/Terraform lock |
