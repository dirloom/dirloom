...
**Statut : publiée (`v0.3.3`).** Ce n'est pas un nouveau jalon stratégique et il ne rouvre pas CHANGE.
...
- artefact structurel canonique v1 ;
- projection d'identité v1 et encodage canonique v1 (DLMI) ;
- `dirloom fingerprint` texte et JSON (`schemaVersion` 1) ;
