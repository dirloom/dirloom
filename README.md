...
Scoop installs the correct x64 or ARM64 release, verifies its SHA-256 digest and
adds `dirloom` to your `PATH`. Upgrade with `scoop update dirloom`.
...
The official [Scoop bucket](https://github.com/dirloom/scoop-bucket) polls
published stable releases and updates its x64 and ARM64 manifest automatically.
